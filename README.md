...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/plain-silence-8deb)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/plain-silence-8deb#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/plain-silence-8deb
```

A live public deployment of this template is available at [https://plain-silence-8deb.templates.workers.dev](https://plain-silence-8deb.templates.workers.dev)
